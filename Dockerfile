...
# Added ARGs for CI/CD flexibility
...
# Install git and clone the repository directly inside the container
...
# FIX: Copy os-packages.txt from the source-fetcher stage instead of local context
